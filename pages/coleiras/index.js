  ...
  return (
    <>
      ...
      <main className="flex flex-1 h-full my-5 mx-5 justify-center items-center flex-col">
        ...
        <h2 className="italic text-center">Coleiras Fio A Fio Trançadas a Mão <br/>De<br/>Sua Preferencia!</h2>
        ...
        <div className="flex">
          <Link href={"/coleiras/fina"} className="flex w-1/2 m-5">
          ...
          <Link href={"/coleiras/grossa"} className="flex w-1/2 m-5">
          <div className="bg-neutral-700 p-5 w-full items-center justify-center text-center rounded-lg">
