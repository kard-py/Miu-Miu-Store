    ...
    return (
        ...
        <main className="flex flex-1 h-full w-full p-5 justify-center items-center ">
            <div className="flex flex-1 h-[550px] justify-center items-center">
                ...
                <Link href="/gerenciamento" className="select-none w-full m-1 bg-black h-full text-2xl font-bold text-white hover:bg-green-600 flex flex-1 justify-center items-center text-center duration-300 shadow-zinc-800 shadow-md">Gerenciamento<br/>Da<br/>Loja</Link>
            </div>
        </main>
        <Footer/>
        </>
