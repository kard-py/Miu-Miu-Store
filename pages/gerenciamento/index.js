  ...
  return (
    <>
      ...
      <main className="flex flex-col justify-center items-center">
        ...
        <Link href="/gerenciamento/pedidos" className="m-5 duration-300 hover:bg-green-600 bg-black text-white font-bold text-sm flex flex-1 justify-center rounded-md text-center items-center w-64 h-64">Cadastro<br />De<br />Cores</Link>
